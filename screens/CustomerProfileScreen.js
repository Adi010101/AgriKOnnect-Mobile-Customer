        ...
        <View style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.subcontainer}>
                    ...
                    <TouchableOpacity style={styles.ButtonContainer} onPress={()=>navigation.navigate('Discounts')}>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                            <McIcons name='ticket-percent'size={50} color='#5F5B5B'/>
                            <Text style={styles.ButtonTitle}> Coupon/Discounts</Text>
                            <MiIcons style={styles.forwardIcon} name='arrow-forward-ios'size={20} color='#5F5B5B'/>
                        </View>
                    </TouchableOpacity>
